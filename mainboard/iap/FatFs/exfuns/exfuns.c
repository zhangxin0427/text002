...
////返回值:0,成功
////1,失败
//u8 Release_Mallco(void)
//{
//	u8 res[5];
//	
//	res[0]=mem_free((u32 )fs[0]);	
//	res[1]=mem_free((u32 )fs[1]);	
//	res[2]=mem_free((u32 )file);		
//	res[3]=mem_free((u32 )ftemp);		
//	res[4]=mem_free((u32 )fatbuf);	
//	
//	if(res[0]&&res[1]&&res[2]&&res[3]&&res[4])return 0;  //
//	else return 1;	
//}
